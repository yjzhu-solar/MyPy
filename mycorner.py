...
def corner(xs, bins=20, range=None, weights=None, color="k", hist_bin_factor=1,
           ...
           hist_kwargs=None, hist_fill_color=None, **hist2d_kwargs):
    """
    ...
    **hist2d_kwargs
    ...
    if fig is None:
        fig, axes = pl.subplots(K, K, figsize=(dim, dim),constrained_layout=True)
    else:
        try:
    ...
    for i, x in enumerate(xs):
        ...
        if smooth1d is None:
            ...
            if hist_fill_color is not None:
                ax.hist(x, bins=bins_1d, weights=weights,
                              range=np.sort(range[i]), color=hist_fill_color,alpha=0.4)
...
def hist2d(x, y, bins=20, range=None, weights=None, levels=None, smooth=None,
           ax=None, color=None, density_cmap=None, quiet=False,
    ...
    if density_cmap is None:
        ...
        pass
        # density_cmap_list = [density_cmap(i) for i in range(density_cmap.N)]
        # density_cmap_list[-1] = (0,0,0,0)
        # density_cmap = LinearSegmentedColormap.from_list("mcm",density_cmap_list,density_cmap.N)
